...
function mostrarResultados() {
    ...
    if(puntaje > 30){
        estiloVida = "<spam id='estilo-exelente'>EXELENTE</spam>";
    }else if (puntaje > 25 ) {
    ...
    div.innerHTML += `backticks
    '<p class='resultado_obtenido'> Has obtenido ${puntaje} puntos, lo cual significa que tu estilo de vida es ${estiloVida}.</p>' backticks`
    ;

}

function actualizarpuntaje(opcion) {
    var indice =opcione = 1;
...
function siguientePregunta(){
    ...
    document.getElementById("opc4").innerHTML = opciones[i][3];
    document.getElementById("opc5").innerHTML = opciones[i][4];
